...
public class SwingMenuDemoWithPopApp implements ActionListener {

    JLabel jlab;
    JPopupMenu jpop;  //jpor hold a reference to the popup menu

    SwingMenuDemoWithPopApp() {
       ...
       //Create and edit popup menu and poppu menu items
       jpop = new JPopupMenu("Poppup");
       JMenuItem jmiCut = new JMenuItem("Cut");
       JMenuItem jmiCopy = new JMenuItem("Copy");
       JMenuItem jmiPaste = new JMenuItem("Paste");

       //Add the munu items to the popup menu
       jpop.add(jmiCut);
       jpop.add(jmiCopy);
       jpop.add(jmiPaste);

       //Add listener for the popup trigger
